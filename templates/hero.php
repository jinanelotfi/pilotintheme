<div class="hero-container">            
    <div class="left-talk">
        <h2>
            Meet the future<br> of your<br> <span>organization</span><br>today
        </h2>
        <h1>
        ...
        <div class="logos-entreprises pin">
            ...
            <img class="republique-logo" src="<?php echo get_template_directory_uri() . '/assets/images/republique-logo.png'; ?>" alt="republique logo">
        </div>
    </div>
