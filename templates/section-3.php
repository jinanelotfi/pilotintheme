...
<div class="second-white-container pin">
    <div class="left-propilot-connexion">
        ...
        <div class="list-icones-propilot">
            <span>
                <img class="sheet-icon" src="<?php echo get_template_directory_uri() . '/assets/images/i5.png'; ?>" alt="icone arbre connecté">
                <h2>Connect strategic plans to execution</h2>
            </span>
            <span>
                <img class="cadenas-icon" src="<?php echo get_template_directory_uri() . '/assets/images/i6.png'; ?>" alt="icone courbe montante">
                <h2>Know the status of plans</h2>
            </span>
            <span>
                <img class="fromage-icon" src="<?php echo get_template_directory_uri() . '/assets/images/i7.png'; ?>" alt="icone point d'exclamation">
                <h2>Adapt quickly to changes</h2>
            </span>
            <span>
                <img class="sheet-icon" src="<?php echo get_template_directory_uri() . '/assets/images/i8.png'; ?>" alt="icone trophée">
